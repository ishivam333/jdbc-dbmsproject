...
INSERT INTO order_table VALUES(109,3000,"2021-09-10",5,3);
...
from customer 
where cus_id in
( select cus_id from order_table where ord_amount>=3000) 
group by cus_gender;
...
-- query 6 Create a view as lowest_expensive_product and display the least expensive product from each category and print the table with category id, name, product name and price of the product.
...
DELIMITER //
CREATE PROCEDURE CalculateSupplierRatings()
BEGIN
